...
(function (root, factory) {
  ...
  var LINES = {
    mean: {
      ...
      clipsMarked: ['Stuck {count} 🔥 markers on the bits worth posting. The rest is… content.'],
      trimmed: ['Cut {time} of people staring at each other.'],
    ...
    nice: {
      ...
      clipsMarked: ['Added {count} best-clip markers.'],
      trimmed: ['Trimmed {time} of dead air.'],

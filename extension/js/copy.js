...
(function (root, factory) {
  ...
  var LINES = {
    mean: {
      ...
      multicamDone: ['{markers} shots marked in “{name}”. Premiere won’t let scripts click multicam angles, so the markers tell you which one. Clicky clicky.'],
    ...
    nice: {
      ...
      multicamDone: ['Marked {markers} shots in “{name}”. Premiere doesn’t let scripts switch multicam angles, so each marker names the angle to pick.'],
